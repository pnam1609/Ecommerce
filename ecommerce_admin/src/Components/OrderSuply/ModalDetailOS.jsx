        ...
        <div className="modal-content">
          <div className="py-3 mb-20" >
            <h3 className="m-0 font-weight-bold text-primary" style={{ textAlign: 'center' }}>
              Các sản phẩm của đơn đặt hàng: <span className="text-danger">{item.MA_DDH}</span>
            </h3>
          </div>
          {item.CT_DDH.length === 0 ? "Đơn đặt hàng này không có phiếu nhập" :
            <>
