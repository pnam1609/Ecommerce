                    ...
                    <div className="payment border-top mt-3 mb-3 border-bottom table-responsive">
                      <table className="table table-borderless">
                        <tbody>
                          <tr>
                            <td>
                              <div className="py-2"> <span className="d-block text-muted">Ngày đặt</span> <span>{formatDate(new Date(item.NGAYTAOHD))}</span> </div>
                            </td>
                            <td>
                            ...
                            <td>
                              <div className="py-2"> <span className="d-block text-muted">Mã số thuế</span> <span>{item.MASOTHUE}</span> </div>
                            </td>
                          </tr>
                        </tbody>
                      </table>
