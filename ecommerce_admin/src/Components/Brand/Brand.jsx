    ...
    function filterBrand(list, value) {
        if (value === null || value === undefined) return list
            ...
            list = list.filter(params => {
                return params.MA_HANG.toLowerCase().indexOf(value.toLowerCase()) !== -1
                    || params.TENHANG.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").indexOf(value.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "")) !== -1
